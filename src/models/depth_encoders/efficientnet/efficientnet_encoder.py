...
class EfficientNetEncoderDecoder(nn.Module):
    """
    ...
    def __init__(
            ...
            decoder_channels=(512, 256, 128, 64, 32), # choices: (256, 128, 64, 32, 16); (1536, 768, 384, 192)
            in_channels=1,
            num_classes=5,
            center=False,
        ...
        if backbone != "tf_efficientnet_b5_ap":
            raise RuntimeError(
                f"Unknown backbone {backbone}!\n"
                f"Existing model should be tf_efficientnet_b5_ap "
            )

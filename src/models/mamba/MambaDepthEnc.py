...
def get_mambaDepth_enc_model(config):
    ...
    depth_network_class_name = 'MambaDepthEnc'
    network_class = MambaDepthEnc
    kwargs = {
        'MambaDepthEnc':
            {
                'conv_bias': True,
...
if __name__ == "__main__":
    ...
    conf = MambaDepthEnc_320x1024_Conf().conf
